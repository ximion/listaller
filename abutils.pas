...
{$IFDEF LINUX}
function mkstemp(_para1:Pchar):longint;cdecl;external 'libc' name 'mkstemp';
function mktemp(_para1:Pchar):Pchar;cdecl;external 'libc' name 'mktemp';
{$ENDIF LINUX}
...
{$IFDEF LINUX}
  ...
  fpstat(PAnsiChar(aFileName), StatBuf);
