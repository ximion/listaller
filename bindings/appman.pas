...
uses
 ...
 function  li_remove_ipk_installed_app(appname, appid: PChar;scall: TLiStatusChangeCall;fastmode: Boolean): Boolean; cdecl; external libinst name 'li_remove_ipk_installed_app';
