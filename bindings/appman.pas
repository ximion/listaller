...
uses
 ...
 function  li_mgr_register_msg_call(mgr: Pointer;call: TMessageCall; user_data: Pointer): Boolean;cdecl;external libinst name 'li_mgr_register_msg_call';
 function  li_mgr_register_progress_call(mgr: Pointer;call: TProgressCall;user_data: Pointer): Boolean;cdecl;external libinst name 'li_mgr_register_progress_call';
 function  li_mgr_register_request_call(mgr: Pointer;call: TRequestCall;user_data: Pointer): TRqResult;cdecl;external libinst name 'li_mgr_register_request_call';
