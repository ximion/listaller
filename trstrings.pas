...
strActionNotPossiblePkg='The selected action is not possible with this package.'#13'Please contact the package maintainer to get more information.';
...
strHashError='Hash doesn''t match!'#13'The package may be modified after creation.'#13'Please obtain a new copy';
...
strNoGUIPkgManFound='Could not find usable GUI package manager.'#13'Please install a PackageKit-GUI!';
...
strListallerAlien='Listaller uses "alien" to convert foreign packages, but the tool is not installed'#13'Do you want to install "alien" now to continue?';
...
strConfigureListaller='Configure Listaller';
...
strCannotHandleRM='This application is not a MoJo-Installation and no other package-type Listaller can handle.'#13'You have to remove it manually.';
