...
strInstFailed='Installation failed.';
...
strNotifyDevs='Please notify the developers on http://launchpad.net/listaller';
...
strwAllow='Do you want confirm this action?';
strLiCloseANI='Listaller will close now. The package couldn''t be installed.';
strStep2='Phase 2/4: Installing files...';
strStep3='Phase 3/4: Chmod new files...';
strStep4='Phase 4/4: Registering application...';
strAddUpdSrc='The installation tries to add the following update source: ';
strQAddUpdSrc='Should this source be added to the update sources list?';
strFinished='Finished';
strinstAnyway='Do you want to install it anyway? (This could raise problems)';
strInvarchitecture='The application which this package contains was not built for the current system architecture.';
strWillDLFiles='(This program will download the needed files from the internet)';
strInvalidDVersion='Package was not build for your Linux distribution release.';
strFTPfailed='Problem while downloading the packages. Maybe the login on the FTP-Server failed.';
strSuccess='Success!';
strMain='Main';
strDetails='Details';
strInstallation='Installation';
strNoLDSources='There are no sources available for your Linux distribution'#10'Try to install common packages?';
strUseCompPQ='Use compatible packages?';
strNoComp='No compatible packages found!';
strActionNotPossiblePkg='The selected action is not possible with this package.'#10'Please contact the package maintainer to get more information.';
strIDInvalid='This package has no valid ID'#10'The installer will close.';
strReInstall='Re-install';
...
strHashError='Hash doesn''t match!'#10'The package may be modified after creation.'#10'Please obtain a new copy';
strInstallationMode='Installation mode:';
strIModeInstruction='Select which parts of the application should be installed.';
strMode='Mode';
strCleanUp='Cleaning up...';
{ExecMode Form
-----------------}
strWantToDoQ='What do you want to do?';
strPackageKitWarning='Your PackageKit version is %cp. Listaller needs PackageKit %np or higher to work correctly.'#10'Please update PackageKit!';
strSpkWarning='Make sure that you have got this package from a save source and a serious publisher!';
...
strReady='Ready.';
strConvertPkg='You want to install an %x-Package, but your Linux-Distribution''s package system is %y.'#10'This package can be converted using "alien", but this will take some time and eventually the application won''t work'#10'Do you want to convert the package now?';
strConvertPkgQ='Convert package?';
strConvTitle='Converting %p package...';
strFiltering='Filtering...';
strFilter='Filter...';
strLoading='Loading...';
strInstalledApps='Installed applications';
strInstallPkg='Install package';
strBrowseCatalog='Browse catalog';
strRepositories='Repositories';
strSettings='Settings';
strNoGUIPkgManFound='Could not find usable GUI package manager.'#10'Please install a PackageKit-GUI!';
strUseLaunchpadForBugs='Please use https://bugs.launchpad.net/listaller for bug reports.';
...
strListallerAlien='Listaller uses "alien" to convert foreign packages, but the tool is not installed'#10'Do you want to install "alien" now to continue?';
...
strBrowseLiCatalog='Browse Listaller''s software catalog';
strOpenDistriCatalog='Open your distribution''s package catalog';
strAbout='About';
strAuthors='Authors';
...
strSourceDeleted='Source was removed.';
strPleaseSelectListItem='Please select an item from the list!';
strLiUpdateAccessFailed='Cannot access the liUpdate tool. Maybe it is not installed?';
strChangePkgManSettings='Change package manager settings';
//Catalogue
strCategory='Category:';
strWInstallDl='Select software you want to download and to install:';
strNoInfo='No information available!';
strDLSetUp='Downloading setup package...';
...
strCannotHandleRM='This application is not a MoJo-Installation and no other package-type Listaller can handle.'#10'You have to remove it manually.';
strRMUnsdDeps='Uninstalling unused deps...';
strUninstalling='Uninstalling...';
strRMPkg='Do you really want to remove "%p", containing %a?'#10'The following package(s) will be removed also: %pl'#10'If you aren''t sure that you won''t need those packages, press "No"!';
strRmPkgQ='Really remove?';
strWaiting='Waiting...';
strRMAppC='Uninstalling %a';
strLinDesk='Running under %de.';
{Updater
---------}
...
strShowUpdater='Show';
strQuitUpdater='Quit';
strUpdInstalling='Applying updates...';
