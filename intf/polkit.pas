...
const
 ...
 POLKIT_CHECK_AUTHORIZATION_FLAGS_ALLOW_USER_INTERACTION = (1 shl 0);
...
procedure polkit_authority_check_authorization(authority: PPolkitAuthority;subject: PPolkitSubject;action_id: PGChar;
                                                      details: PPolkitDetails;flags: GUInt;cancellable: PGCancellable;
                                                      callback: GAsyncReadyCallback;user_data: GPointer);cdecl;external libpolkit;
...
function  polkit_authorization_result_get_locked_down(result: PPolkitAuthorizationResult): GBoolean;cdecl;external libpolkit;
