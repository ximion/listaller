...
uses                                                
  {$IFNDEF PASBITMAP} Windows, {$ELSE} wincomp, {$ENDIF}
  Classes, SysUtils,
  {$IFNDEF PASBITMAP} Graphics, {$ENDIF}
  {$IFDEF USEJPEG} JPG, {$ENDIF}  // JPEG compression support
    ...
    begin
      ...
      begin
        ...
        R.Key := Accumulator and $FF;
         R.Mask := not ((1 shl (32 - R.Length)) - 1); //theo
{        asm
